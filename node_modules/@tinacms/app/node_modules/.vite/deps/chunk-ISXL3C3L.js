...
function $d4ee10de306f2510$export$e58f029f0fbfdb29(event) {
  if ((0, $f4e2df6bd15f8569$export$98658e8c59125e6a)() && event.target instanceof Element && event.target.shadowRoot) {
    ...
    if ("composedPath" in event)
      return (_event_composedPath_ = event.composedPath()[0]) !== null && _event_composedPath_ !== void 0 ? _event_composedPath_ : null;
    else if ("composedPath" in event.nativeEvent)
      return (_event_nativeEvent_composedPath_ = event.nativeEvent.composedPath()[0]) !== null && _event_nativeEvent_composedPath_ !== void 0 ? _event_nativeEvent_composedPath_ : null;
  }
  return event.target;
}
  ...
  for (let i = 1; i < args.length; i++) {
    ...
    for (let key in props) {
      ...
      90)
        ...
        result.ref = (0, $5dc95899b306f630$export$c9058316764c140e)(a, b);
      else
...
function $6179b936705e76d3$export$ae780daf29e6d456(props) {
  ...
  let { hoverProps, triggerHoverEnd } = (0, import_react23.useMemo)(() => {
    let triggerHoverStart = (event, pointerType) => {
      ...
      if (isDisabled || pointerType === "touch" || state.isHovered || !(0, $d4ee10de306f2510$export$4282f70798064fe0)(event.currentTarget, (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(event)))
        return;
      ...
      addGlobalListener((0, $431fbd86ca7dc216$export$b204af158042fbac)((0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(event)), "pointerover", (e) => {
        if (state.isHovered && state.target && !(0, $d4ee10de306f2510$export$4282f70798064fe0)(state.target, (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e)))
    ...
    if (typeof PointerEvent !== "undefined") {
      ...
      hoverProps2.onPointerLeave = (e) => {
        if (!isDisabled && (0, $d4ee10de306f2510$export$4282f70798064fe0)(e.currentTarget, (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e)))
          triggerHoverEnd2(e, e.pointerType);
      };
    } else if (false) {
...
function $f6c31cce2adf654f$export$45712eceda6fad21(props) {
  ...
  let triggerPressStart = (0, import_react26.useCallback)((originalEvent, pointerType) => {
  ...
  let triggerPressEnd = (0, import_react26.useCallback)((originalEvent, pointerType, wasPressed = true) => {
    let state = ref.current;
  ...
  let triggerPressUp = (0, import_react26.useCallback)((originalEvent, pointerType) => {
    let state = ref.current;
    if (isDisabled)
      return false;
    if (onPressUp) {
  ...
  let cancel = (0, import_react26.useCallback)((e) => {
    let state = ref.current;
  ...
  let cancelOnPointerExit = (0, import_react26.useCallback)((e) => {
  ...
  let triggerClick = (0, import_react26.useCallback)((e) => {
    if (isDisabled)
      return;
  ...
  let triggerSyntheticClick = (0, import_react26.useCallback)((e, target) => {
    if (isDisabled)
      return;
    if (onClick) {
  ...
  let [isElemKeyPressed, setIsElemKeyPressed] = (0, import_react26.useState)(false);
  (0, $f0a04ccd8dbdd83b$export$e5c5a5f917a5871c)(() => {
    let state = ref.current;
    if (isElemKeyPressed) {
      let onKeyUp = (e) => {
      ...
      let pressUp = (e) => {
        if (originalTarget && $f6c31cce2adf654f$var$isValidKeyboardEvent(e, originalTarget) && !e.repeat && (0, $d4ee10de306f2510$export$4282f70798064fe0)(originalTarget, (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e)) && state.target)
          triggerPressUpEvent($f6c31cce2adf654f$var$createEvent(state.target, e), "keyboard");
      };
  ...
  let [isPointerPressed, setIsPointerPressed] = (0, import_react26.useState)(null);
  (0, $f0a04ccd8dbdd83b$export$e5c5a5f917a5871c)(() => {
    let state = ref.current;
  ...
  let pressProps = (0, import_react26.useMemo)(() => {
    ...
    let pressProps2 = {
      ...
      onClick(e) {
        if (e && !(0, $d4ee10de306f2510$export$4282f70798064fe0)(e.currentTarget, (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e)))
          return;
    ...
    if (typeof PointerEvent !== "undefined") {
      pressProps2.onPointerDown = (e) => {
        if (e.button !== 0 || !(0, $d4ee10de306f2510$export$4282f70798064fe0)(e.currentTarget, (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e)))
          return;
      ...
      pressProps2.onMouseDown = (e) => {
        if (!(0, $d4ee10de306f2510$export$4282f70798064fe0)(e.currentTarget, (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e)))
          return;
        if (e.button === 0) {
      ...
      pressProps2.onPointerUp = (e) => {
        if (!(0, $d4ee10de306f2510$export$4282f70798064fe0)(e.currentTarget, (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e)) || state.pointerType === "virtual")
          return;
...
function $507fabe10e71c6fb$var$handleFocusEvent(e) {
  if ((0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e) === window || (0, $d4ee10de306f2510$export$e58f029f0fbfdb29)(e) === document || (0, $8a9cb279dc87e130$export$fda7da73ab5d4c48) || !e.isTrusted)
    return;
...
tabbable/dist/index.esm.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-ISXL3C3L.js.map
